...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	56450513          	addi	a0,a0,1380 # 800598 <main+0x3c>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800058:	56450513          	addi	a0,a0,1380 # 8005b8 <main+0x5c>
...
exit(int error_code) {
  ...
  800128:	49c50513          	addi	a0,a0,1180 # 8005c0 <main+0x64>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800180:	67c78793          	addi	a5,a5,1660 # 8007f8 <error_string+0xc8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001d4:	404a0a13          	addi	s4,s4,1028 # 8005d4 <main+0x78>
  ...
  8001e0:	554c0c13          	addi	s8,s8,1364 # 800730 <error_string>
  ...
  8002ce:	61e60613          	addi	a2,a2,1566 # 8008e8 <error_string+0x1b8>
  ...
  800462:	47a60613          	addi	a2,a2,1146 # 8008d8 <error_string+0x1a8>
  ...
  800474:	46060613          	addi	a2,a2,1120 # 8008d0 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
  800478:	00000417          	auipc	s0,0x0
  80047c:	45940413          	addi	s0,s0,1113 # 8008d1 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
  ...
  800508:	3cd40413          	addi	s0,s0,973 # 8008d1 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  ...
  800560:	aa478793          	addi	a5,a5,-1372 # 801000 <zero>
  800564:	439c                	lw	a5,0(a5)
  800566:	4585                	li	a1,1
main(void) {
  800568:	1141                	addi	sp,sp,-16
    cprintf("value is %d.\n", 1 / zero);
  80056a:	02f5c5bb          	divw	a1,a1,a5
  80056e:	00000517          	auipc	a0,0x0
  800572:	38250513          	addi	a0,a0,898 # 8008f0 <error_string+0x1c0>
main(void) {
  ...
  800580:	38460613          	addi	a2,a2,900 # 800900 <error_string+0x1d0>
  800584:	45a5                	li	a1,9
  800586:	00000517          	auipc	a0,0x0
  80058a:	38a50513          	addi	a0,a0,906 # 800910 <error_string+0x1e0>
  80058e:	a99ff0ef          	jal	ra,800026 <__panic>
