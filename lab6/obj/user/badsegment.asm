...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	54450513          	addi	a0,a0,1348 # 800578 <main+0x1c>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800058:	54450513          	addi	a0,a0,1348 # 800598 <main+0x3c>
...
exit(int error_code) {
  ...
  800128:	47c50513          	addi	a0,a0,1148 # 8005a0 <main+0x44>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800180:	65c78793          	addi	a5,a5,1628 # 8007d8 <error_string+0xc8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001d4:	3e4a0a13          	addi	s4,s4,996 # 8005b4 <main+0x58>
  ...
  8001e0:	534c0c13          	addi	s8,s8,1332 # 800710 <error_string>
  ...
  8002ce:	5fe60613          	addi	a2,a2,1534 # 8008c8 <error_string+0x1b8>
  ...
  800462:	45a60613          	addi	a2,a2,1114 # 8008b8 <error_string+0x1a8>
  ...
  800474:	44060613          	addi	a2,a2,1088 # 8008b0 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
  800478:	00000417          	auipc	s0,0x0
  80047c:	43940413          	addi	s0,s0,1081 # 8008b1 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
  ...
  800508:	3ad40413          	addi	s0,s0,941 # 8008b1 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  80055c:	1141                	addi	sp,sp,-16
    ...
    panic("FAIL: T.T\n");
  80055e:	00000617          	auipc	a2,0x0
  800562:	37260613          	addi	a2,a2,882 # 8008d0 <error_string+0x1c0>
  800566:	45a5                	li	a1,9
  800568:	00000517          	auipc	a0,0x0
  80056c:	37850513          	addi	a0,a0,888 # 8008e0 <error_string+0x1d0>
main(void) {
