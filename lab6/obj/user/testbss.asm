...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	5ec50513          	addi	a0,a0,1516 # 800620 <main+0xc4>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800058:	5ec50513          	addi	a0,a0,1516 # 800640 <main+0xe4>
...
exit(int error_code) {
  ...
  800128:	52450513          	addi	a0,a0,1316 # 800648 <main+0xec>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800180:	70478793          	addi	a5,a5,1796 # 800880 <error_string+0xc8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001d4:	48ca0a13          	addi	s4,s4,1164 # 80065c <main+0x100>
  ...
  8001e0:	5dcc0c13          	addi	s8,s8,1500 # 8007b8 <error_string>
  ...
  8002ce:	6a660613          	addi	a2,a2,1702 # 800970 <error_string+0x1b8>
  ...
  800462:	50260613          	addi	a2,a2,1282 # 800960 <error_string+0x1a8>
  ...
  800474:	4e860613          	addi	a2,a2,1256 # 800958 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
  800478:	00000417          	auipc	s0,0x0
  80047c:	4e140413          	addi	s0,s0,1249 # 800959 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
  ...
  800508:	45540413          	addi	s0,s0,1109 # 800959 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  ...
  800562:	41a50513          	addi	a0,a0,1050 # 800978 <error_string+0x1c0>
main(void) {
  800566:	e406                	sd	ra,8(sp)
    cprintf("Making sure bss works right...\n");
  800568:	b39ff0ef          	jal	ra,8000a0 <cprintf>
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  80056c:	00001597          	auipc	a1,0x1
  800570:	a9458593          	addi	a1,a1,-1388 # 801000 <bigarray>
    cprintf("Making sure bss works right...\n");
  800574:	87ae                	mv	a5,a1
    for (i = 0; i < ARRAYSIZE; i ++) {
  800576:	4681                	li	a3,0
  800578:	00100637          	lui	a2,0x100
  80057c:	a029                	j	800586 <main+0x2a>
  80057e:	2685                	addiw	a3,a3,1
  800580:	0791                	addi	a5,a5,4
  800582:	00c68f63          	beq	a3,a2,8005a0 <main+0x44>
        if (bigarray[i] != 0) {
  800586:	4398                	lw	a4,0(a5)
  800588:	db7d                	beqz	a4,80057e <main+0x22>
            panic("bigarray[%d] isn't cleared!\n", i);
  80058a:	00000617          	auipc	a2,0x0
  80058e:	40e60613          	addi	a2,a2,1038 # 800998 <error_string+0x1e0>
  800592:	45b9                	li	a1,14
  800594:	00000517          	auipc	a0,0x0
  800598:	42450513          	addi	a0,a0,1060 # 8009b8 <error_string+0x200>
  80059c:	a8bff0ef          	jal	ra,800026 <__panic>
  8005a0:	00001717          	auipc	a4,0x1
  8005a4:	a6070713          	addi	a4,a4,-1440 # 801000 <bigarray>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  8005a8:	4781                	li	a5,0
  8005aa:	001006b7          	lui	a3,0x100
        bigarray[i] = i;
  8005ae:	c31c                	sw	a5,0(a4)
    for (i = 0; i < ARRAYSIZE; i ++) {
  8005b0:	2785                	addiw	a5,a5,1
  8005b2:	0711                	addi	a4,a4,4
  8005b4:	fed79de3          	bne	a5,a3,8005ae <main+0x52>
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  8005b8:	4681                	li	a3,0
  8005ba:	00100737          	lui	a4,0x100
  8005be:	a029                	j	8005c8 <main+0x6c>
  8005c0:	2685                	addiw	a3,a3,1
  8005c2:	0591                	addi	a1,a1,4
  8005c4:	02e68063          	beq	a3,a4,8005e4 <main+0x88>
        if (bigarray[i] != i) {
  8005c8:	419c                	lw	a5,0(a1)
  8005ca:	fed78be3          	beq	a5,a3,8005c0 <main+0x64>
            panic("bigarray[%d] didn't hold its value!\n", i);
  8005ce:	00000617          	auipc	a2,0x0
  8005d2:	3fa60613          	addi	a2,a2,1018 # 8009c8 <error_string+0x210>
  8005d6:	45d9                	li	a1,22
  8005d8:	00000517          	auipc	a0,0x0
  8005dc:	3e050513          	addi	a0,a0,992 # 8009b8 <error_string+0x200>
  8005e0:	a47ff0ef          	jal	ra,800026 <__panic>
        }
    }

    cprintf("Yes, good.  Now doing a wild write off the end...\n");
  8005e4:	00000517          	auipc	a0,0x0
  8005e8:	40c50513          	addi	a0,a0,1036 # 8009f0 <error_string+0x238>
  8005ec:	ab5ff0ef          	jal	ra,8000a0 <cprintf>
    cprintf("testbss may pass.\n");
  8005f0:	00000517          	auipc	a0,0x0
  8005f4:	43850513          	addi	a0,a0,1080 # 800a28 <error_string+0x270>
  8005f8:	aa9ff0ef          	jal	ra,8000a0 <cprintf>

    bigarray[ARRAYSIZE + 1024] = 0;
    // asm volatile ("int $0x14");
    panic("FAIL: T.T\n");
  8005fc:	00000617          	auipc	a2,0x0
  800600:	44460613          	addi	a2,a2,1092 # 800a40 <error_string+0x288>
  800604:	45fd                	li	a1,31
  800606:	00000517          	auipc	a0,0x0
  80060a:	3b250513          	addi	a0,a0,946 # 8009b8 <error_string+0x200>
    bigarray[ARRAYSIZE + 1024] = 0;
  80060e:	00402797          	auipc	a5,0x402
  800612:	9e07a923          	sw	zero,-1550(a5) # c02000 <bigarray+0x401000>
    panic("FAIL: T.T\n");
