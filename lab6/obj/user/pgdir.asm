...
00000000008000c2 <sys_pgdir>:
}

int
sys_pgdir(void) {
    return syscall(SYS_pgdir);
  8000c2:	457d                	li	a0,31
...
exit(int error_code) {
  ...
  8000d4:	47050513          	addi	a0,a0,1136 # 800540 <main+0x30>
...
getpid(void) {
    return sys_getpid();
  8000de:	fd7ff06f          	j	8000b4 <sys_getpid>

00000000008000e2 <print_pgdir>:
}
...
print_pgdir(void) {
    sys_pgdir();
  8000e2:	fe1ff06f          	j	8000c2 <sys_pgdir>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800134:	64878793          	addi	a5,a5,1608 # 800778 <error_string+0xc8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800188:	3d0a0a13          	addi	s4,s4,976 # 800554 <main+0x44>
  ...
  800194:	520c0c13          	addi	s8,s8,1312 # 8006b0 <error_string>
  ...
  800282:	5ea60613          	addi	a2,a2,1514 # 800868 <error_string+0x1b8>
  ...
  800416:	44660613          	addi	a2,a2,1094 # 800858 <error_string+0x1a8>
  ...
  800428:	42c60613          	addi	a2,a2,1068 # 800850 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
  80042c:	00000417          	auipc	s0,0x0
  800430:	42540413          	addi	s0,s0,1061 # 800851 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
  ...
  8004bc:	39940413          	addi	s0,s0,921 # 800851 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
int
main(void) {
  800510:	1141                	addi	sp,sp,-16
  800512:	e406                	sd	ra,8(sp)
    cprintf("I am %d, print pgdir.\n", getpid());
  800514:	bcbff0ef          	jal	ra,8000de <getpid>
  800518:	85aa                	mv	a1,a0
  80051a:	00000517          	auipc	a0,0x0
  80051e:	35650513          	addi	a0,a0,854 # 800870 <error_string+0x1c0>
  800522:	b1fff0ef          	jal	ra,800040 <cprintf>
    print_pgdir();
  800526:	bbdff0ef          	jal	ra,8000e2 <print_pgdir>
    cprintf("pgdir pass.\n");
  80052a:	00000517          	auipc	a0,0x0
  80052e:	35e50513          	addi	a0,a0,862 # 800888 <error_string+0x1d8>
