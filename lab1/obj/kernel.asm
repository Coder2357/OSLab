    ...
    80200196:	610c                	ld	a1,0(a0)
{
    ...
    802001a2:	aca50513          	addi	a0,a0,-1334 # 80200c68 <etext+0x23e>
{
    ...
    8020035a:	bfa50513          	addi	a0,a0,-1030 # 80200f50 <etext+0x526>
}
    ...
    80200368:	85aa                	mv	a1,a0
{
    ...
    80200370:	bfc50513          	addi	a0,a0,-1028 # 80200f68 <etext+0x53e>
{
    ...
    802003bc:	c1050513          	addi	a0,a0,-1008 # 80200fc8 <etext+0x59e>
}
...
void interrupt_handler(struct trapframe *tf)
{
    ...
    802003ec:	83050513          	addi	a0,a0,-2000 # 80200c18 <etext+0x1ee>
    802003f0:	c7dff06f          	j	8020006c <cprintf>
        cprintf("Hypervisor software interrupt\n");
    802003f4:	00001517          	auipc	a0,0x1
    802003f8:	80450513          	addi	a0,a0,-2044 # 80200bf8 <etext+0x1ce>
    802003fc:	c71ff06f          	j	8020006c <cprintf>
        cprintf("User software interrupt\n");
    80200400:	00000517          	auipc	a0,0x0
    80200404:	7b850513          	addi	a0,a0,1976 # 80200bb8 <etext+0x18e>
    80200408:	c65ff06f          	j	8020006c <cprintf>
        cprintf("Supervisor software interrupt\n");
    8020040c:	00000517          	auipc	a0,0x0
    80200410:	7cc50513          	addi	a0,a0,1996 # 80200bd8 <etext+0x1ae>
    ...
    8020041c:	83050513          	addi	a0,a0,-2000 # 80200c48 <etext+0x21e>
    80200420:	c4dff06f          	j	8020006c <cprintf>
{
    ...
    8020045c:	7e050513          	addi	a0,a0,2016 # 80200c38 <etext+0x20e>
    ...
    80200482:	0141                	addi	sp,sp,16
                sbi_shutdown();
    80200484:	5520006f          	j	802009d6 <sbi_shutdown>
...
void exception_handler(struct trapframe *tf)
{
    ...
    8020048e:	00f76b63          	bltu	a4,a5,802004a4 <exception_handler+0x1c>
    80200492:	4705                	li	a4,1
    80200494:	00f71733          	sll	a4,a4,a5
    80200498:	6785                	lui	a5,0x1
    8020049a:	17dd                	addi	a5,a5,-9
    8020049c:	8ff9                	and	a5,a5,a4
    8020049e:	e789                	bnez	a5,802004a8 <exception_handler+0x20>
    802004a0:	8b21                	andi	a4,a4,8
    802004a2:	e701                	bnez	a4,802004aa <exception_handler+0x22>
    ...
    802004a8:	8082                	ret
{
    ...
    802004b0:	00000517          	auipc	a0,0x0
    802004b4:	6c850513          	addi	a0,a0,1736 # 80200b78 <etext+0x14e>
{
    802004b8:	e406                	sd	ra,8(sp)
        cprintf("Exception type: breakpoint\n");
    802004ba:	bb3ff0ef          	jal	ra,8020006c <cprintf>
        cprintf("ebreak caught at 0x%016llx\n", tf->epc);
    802004be:	10843583          	ld	a1,264(s0)
    802004c2:	00000517          	auipc	a0,0x0
    802004c6:	6d650513          	addi	a0,a0,1750 # 80200b98 <etext+0x16e>
...
static inline void trap_dispatch(struct trapframe *tf)
{
    ...
    802004e8:	fa1ff06f          	j	80200488 <exception_handler>
        interrupt_handler(tf);
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    802005e8:	b8c78793          	addi	a5,a5,-1140 # 80201170 <error_string+0x38>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    8020063c:	9a4a0a13          	addi	s4,s4,-1628 # 80200fdc <etext+0x5b2>
    ...
    80200648:	af4c0c13          	addi	s8,s8,-1292 # 80201138 <error_string>
    ...
    80200736:	aee60613          	addi	a2,a2,-1298 # 80201220 <error_string+0xe8>
    ...
    802008ca:	94a60613          	addi	a2,a2,-1718 # 80201210 <error_string+0xd8>
    ...
    802008dc:	93060613          	addi	a2,a2,-1744 # 80201208 <error_string+0xd0>
            if (width > 0 && padc != '-') {
    802008e0:	00001417          	auipc	s0,0x1
    802008e4:	92940413          	addi	s0,s0,-1751 # 80201209 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
    ...
    80200970:	89d40413          	addi	s0,s0,-1891 # 80201209 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
