    ...
    80200196:	610c                	ld	a1,0(a0)
{
    ...
    802001a2:	b6250513          	addi	a0,a0,-1182 # 80200d00 <etext+0x296>
{
    ...
    8020035a:	c9250513          	addi	a0,a0,-878 # 80200fe8 <etext+0x57e>
}
    ...
    80200368:	85aa                	mv	a1,a0
{
    ...
    80200370:	c9450513          	addi	a0,a0,-876 # 80201000 <etext+0x596>
{
    ...
    802003bc:	ca850513          	addi	a0,a0,-856 # 80201060 <etext+0x5f6>
}
...
void interrupt_handler(struct trapframe *tf)
{
    ...
    802003ec:	8c850513          	addi	a0,a0,-1848 # 80200cb0 <etext+0x246>
    802003f0:	c7dff06f          	j	8020006c <cprintf>
        cprintf("Hypervisor software interrupt\n");
    802003f4:	00001517          	auipc	a0,0x1
    802003f8:	89c50513          	addi	a0,a0,-1892 # 80200c90 <etext+0x226>
    802003fc:	c71ff06f          	j	8020006c <cprintf>
        cprintf("User software interrupt\n");
    80200400:	00001517          	auipc	a0,0x1
    80200404:	85050513          	addi	a0,a0,-1968 # 80200c50 <etext+0x1e6>
    80200408:	c65ff06f          	j	8020006c <cprintf>
        cprintf("Supervisor software interrupt\n");
    8020040c:	00001517          	auipc	a0,0x1
    80200410:	86450513          	addi	a0,a0,-1948 # 80200c70 <etext+0x206>
    ...
    8020041c:	8c850513          	addi	a0,a0,-1848 # 80200ce0 <etext+0x276>
    80200420:	c4dff06f          	j	8020006c <cprintf>
{
    ...
    8020045c:	87850513          	addi	a0,a0,-1928 # 80200cd0 <etext+0x266>
    ...
    8020049e:	ef99                	bnez	a5,802004bc <exception_handler+0x34>
{
    ...
    802004f4:	72050513          	addi	a0,a0,1824 # 80200c10 <etext+0x1a6>
    802004f8:	b75ff0ef          	jal	ra,8020006c <cprintf>
        cprintf("ebreak caught at 0x%016llx\n", tf->epc);
    802004fc:	10843583          	ld	a1,264(s0)
    80200500:	00000517          	auipc	a0,0x0
    80200504:	73050513          	addi	a0,a0,1840 # 80200c30 <etext+0x1c6>
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    80200628:	be478793          	addi	a5,a5,-1052 # 80201208 <error_string+0x38>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    8020067c:	9fca0a13          	addi	s4,s4,-1540 # 80201074 <etext+0x60a>
    ...
    80200688:	b4cc0c13          	addi	s8,s8,-1204 # 802011d0 <error_string>
    ...
    80200776:	b4660613          	addi	a2,a2,-1210 # 802012b8 <error_string+0xe8>
    ...
    8020090a:	9a260613          	addi	a2,a2,-1630 # 802012a8 <error_string+0xd8>
    ...
    8020091c:	98860613          	addi	a2,a2,-1656 # 802012a0 <error_string+0xd0>
            if (width > 0 && padc != '-') {
    80200920:	00001417          	auipc	s0,0x1
    80200924:	98140413          	addi	s0,s0,-1663 # 802012a1 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
    ...
    802009b0:	8f540413          	addi	s0,s0,-1803 # 802012a1 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
