    ...
    80200420:	c4dff06f          	j	8020006c <cprintf>
{
    ...
    8020045e:	87650513          	addi	a0,a0,-1930 # 80200cd0 <etext+0x266>
    ...
    802004a0:	ef99                	bnez	a5,802004be <exception_handler+0x34>
{
    ...
    802004f6:	71e50513          	addi	a0,a0,1822 # 80200c10 <etext+0x1a6>
    802004fa:	b73ff0ef          	jal	ra,8020006c <cprintf>
        cprintf("ebreak caught at 0x%016llx\n", tf->epc);
    802004fe:	10843583          	ld	a1,264(s0)
    80200502:	00000517          	auipc	a0,0x0
    80200506:	72e50513          	addi	a0,a0,1838 # 80200c30 <etext+0x1c6>
